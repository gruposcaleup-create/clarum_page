...
export const ArtificialHero = () => {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '100%', background: '#000', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div className="font-light tracking-tighter" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          Research & Vision by @clarumlab
        </div>
      </div>

      {/* Canvas Container */}
      <div style={{ position: 'sticky', top: 0, width: '100%', height: '100vh', zIndex: 10 }}>
        <canvas
          ref={canvasRef}
          style={{
            position: 'absolute',
